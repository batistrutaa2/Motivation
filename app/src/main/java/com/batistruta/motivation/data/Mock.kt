package com.batistruta.motivation.data
...
class Mock {
    ...
    private val all = MotivationConstants.FILTERS.ALL
    private val sunny = MotivationConstants.FILTERS.SUNNY
    private val happy = MotivationConstants.FILTERS.HAPPY
